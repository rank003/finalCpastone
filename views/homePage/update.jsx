  ...
  <div style={{...styles.sectionContainer}}>
    ...
    <div class="form-container">
        <form style={{ ...styles.form }} action={`/Elle/update/${myOutput.id}`}method='POST'>
            ...
            <input type="email" name="email"   defaultValue={myOutput.name} required />
            ...
            <input type="date" name="date"  defaultValue={myOutput.name} equired />

            <label htmlFor="time">Time:</label>
            <input type="time" name="time"  defaultValue={myOutput.name} required />
